...
Nu hebben we dus alles wat nodig is om zonder de lijnen te trekken het laatste snijpunt te vinden, wat niet vergeten moet worden is dat om de optelling te voltooien dit punt nog gespiegeld moeten worden in de $x$-as, ofwel als het laatste snijpunt $(x_R,y_R)$ is het resultaat van de optelling $(-x_R,y_R)$.
